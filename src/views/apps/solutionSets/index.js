...
//         <div className="min-h-screen bg-gray-50">
//           <header className="w-full bg-white shadow-lg flex items-center p-4">
//     {/* Container for icons and title on the left */}
//     <div className="flex items-center gap-2">
//         <Home className="text-gray-700" size={20} />
//         <ChevronRight className="text-gray-700" size={20} />
//         <span className="text-sm font-bold">SOLUTION SETS</span>
//     </div>
// </header>
...
//                         <div
//                             key={country.cca3}
//                             className="rounded-lg shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1 border border-gray-200 bg-white"
//                         >
