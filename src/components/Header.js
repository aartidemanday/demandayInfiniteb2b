...
//     return (
//         <header className="bg-gradient-to-r from-teal-500 to-[#4702a2] m-2">
...
//                         <button className="bg-white text-[#4702a2] text-sm font-semibold px-6 py-2 rounded-full hover:bg-gray-100">
//                             Create Account
//                         </button>
//                     </div>
//                 </div>
...
//             <div className={`lg:hidden ${menuOpen ? 'block' : 'hidden'} bg-gradient-to-r from-teal-500 to-[#4702a2] p-4`}>
//                 <nav className="space-y-4">
//                     <button 
//                         className="text-white hover:underline w-full"
//                         onClick={() => navigate('/home')}
