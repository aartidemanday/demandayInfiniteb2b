...
const PdfPreview = ({ pdfUrl, description }) => {
  return (
    ...
    <div className="flex items-start bg-gray-100 p-4 rounded-md shadow-md relative">
        
      {/* PDF Preview (like an image) */}
      <div className="w-52 h-72 bg-gray-200 flex items-center justify-center text-gray-500 rounded-md overflow-hidden mr-4">
        {/* PDF Thumbnail */}
      ...
      <p className="flex-1 text-xl font-serif text-gray-700 mr-4 m-4">  
        {/* //Poppins */}
        {/* {description} */}
       <strong className="text-teal-900"> After Implementing ABM With Engagio, Versionone Achieved 88% Engagement With Target Accounts, 66% Increase In Value Of Target Accounts And A Significa
